...
% Virus parameters
global D_phi p_phi_max r_rep r_phi k_phi c_phi d_phi;
D_phi = 1;
p_phi_max = 10;
r_rep = 0.125;
r_phi = 1.5;
...
[x,Y]=ode15s(@MOL_deriv_virus,[0 maxT],y0,options);
toc;
...
figure;
subplot(2,2,1)
surf(linspace(0,1,1/xi_step + 1),x,Y(:,4*(1/xi_step + 1) + 1:5*(1/xi_step + 1)),'EdgeColor','none')
...
subplot(2,2,2)
surf(linspace(0,1,1/xi_step + 1),x,Y(:,5*(1/xi_step + 1) + 1:6*(1/xi_step + 1)),'EdgeColor','none')
axis square;
